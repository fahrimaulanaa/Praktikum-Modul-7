                ...
                <div class="w-full lg:w-1/2 p-5 rounded-lg lg:rounded-l-none bg-gray-200">
                    ...
                    <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" action="dosen-update.php" method="POST">
                        ...
                        <div class="mb-6 text-center">
                            ...
                            <br>
                            <br>
                            <button type="button" class="w-full px-6 py-2 border-2 border-blue-600 text-blue-600 font-medium text-xs leading-tight uppercase rounded-full hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                                Back
                            </button>
                        </div>
                    </form>
